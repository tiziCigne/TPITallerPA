...
public class CrudSpringBootApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Servicio servicio1 = new Servicio("Cambio de aceite", "Cambia el aceite de un auto", BigDecimal.valueOf(5.0000));
		repositorioServicio.save(servicio1);
		
		Servicio servicio2 = new Servicio("Mecanica ligera", "Cambiar amortiguador", BigDecimal.valueOf(30.000));
