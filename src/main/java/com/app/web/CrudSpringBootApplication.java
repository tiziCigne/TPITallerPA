...
public class CrudSpringBootApplication implements CommandLineRunner{
	...
	/*
		...
		Cliente cliente = new Cliente("Celia","Mabel","celia69", "154250048", "Santa Fe 120", "DNI", new Date());
		repositorioCliente.save(cliente);
		
		Cliente cliente2 = new Cliente("Alvaro","Pineda","alva99@gmailcom", "775533", "B. Sarmiento 44", "Zapato", new Date());
